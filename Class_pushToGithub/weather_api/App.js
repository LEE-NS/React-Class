    ...
    <div>
      {
        loading ? (
          <div className='container'>
            <ClipLoader color="#AAA" loading={loading} size={80}/>
          </div>
        ) : (
          <div className='container'>
            <WeatherBox weather={weather} />
            <WeatherButtons cities={cities} setCity={setCity} handleCityChange={handleCityChange} city={city}/>
          </div>
        )
      }
    </div>
